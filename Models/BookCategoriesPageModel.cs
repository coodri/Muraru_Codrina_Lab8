...
namespace Muraru_Codrina_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Muraru_Codrina_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Muraru_Codrina_Lab8Context context,
